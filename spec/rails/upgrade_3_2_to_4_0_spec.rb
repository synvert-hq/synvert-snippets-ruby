...
class ActiveSupport::TestCase
  ...
  let(:fake_file_paths) {
    %w[
      ...
      config/routes.rb
      db/migrate/20140101000000_change_posts.rb
      db/schema.rb
      app/models/post.rb
  ...
  let(:test_rewritten_contents) {
    [
      ...
      migration_rewritten_content,
      schema_content,
      post_model_rewritten_content,
      users_controller_rewritten_content,
      posts_controller_rewritten_content,
      posts_index_rewritten_content,
      post_test_rewritten_content,
      test_helper_rewritten_content
    ]
  }
