...
Synvert::Rewriter.new 'rails', 'update_active_storage_variant_argument' do
  ...
  within_files Synvert::ALL_RUBY_FILES + Synvert::ALL_RAKE_FILES do
    with_node node_type: 'call_node',
              name: 'variant',
              arguments: { node_type: 'arguments_node', arguments: { size: 1, first: { node_type: 'keyword_hash_node', resize_value: { node_type: 'string_node', unescaped: { last: 'x' } } } } } do
    ...
    with_node node_type: 'call_node',
              name: 'variant',
              arguments: { node_type: 'arguments_node', arguments: { size: 1, first: { node_type: 'keyword_hash_node', crop_value: { node_type: 'string_node' } } } } do
    ...
    with_node node_type: 'call_node',
              name: 'variant',
              arguments: { node_type: 'arguments_node', arguments: { size: 1, first: { node_type: 'keyword_hash_node', resize_and_pad_value: { node_type: 'array_node', elements: { size: 2 } } } } } do
      insert 'background: [255]', to: 'arguments.arguments.0.elements.0.value.elements.-1', at: 'end', and_comma: true
    end

    with_node node_type: 'call_node',
              name: 'variant',
              arguments: { node_type: 'arguments_node', arguments: { size: 1, first: { node_type: 'keyword_hash_node', monochrome_value: true } } } do
